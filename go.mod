...
require (
	...
	github.com/GPA-Gruppo-Progetti-Avanzati-SRL/go-core-mongo v0.0.18
	github.com/GPA-Gruppo-Progetti-Avanzati-SRL/go-core-sql v0.0.0-20260528172706-4108ce745b4d
